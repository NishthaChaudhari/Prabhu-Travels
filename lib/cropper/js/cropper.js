...
function getCroppedImage(event) {
    event.preventDefault();
    var element = event.target;
    if ($(element).val() == '') {
        $(element).parent().find('.hiddenImg').val('');
        return false;
    }
    var cropperImage = $(element).attr('data-cropper');
    var cropperModal = $(element).attr('data-modal');
    $('#' + cropperModal).modal('show');
    var cropper = null;

    $('#' + cropperModal).on('shown.bs.modal', function() {
        if (!element.files) return false;
        $('#' + cropperImage).attr('src', '').hide();
    ...
    $('.cropButton').click(function() {
        ...
        $(element).parent().find('img').attr('src', croppedImage);
        $(element).parent().find('.hiddenImg').val(croppedImage);
